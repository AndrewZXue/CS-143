      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-2 main">
            <div>
                ...
                <small>Note: Please specify the exact movie/director names</small><br>
                <form action="movie_director.php" method="get">
                	Movie:<br>
                    <textarea name="movie_name" cols="60" rows="1"></textarea><br/>
                    Director:<br>
                    <textarea name="director_name" cols="60" rows="1"></textarea><br/>
                <input type="submit">
                </form>

                <br>
                <?php
                    if(isset($_GET['movie_name']) || isset($_GET['director_name'])){
                        ...
                        if(!$director_name){
                            echo "please specify the director in the relation";
                            exit;
                        }
                        ...
                        $director_query = "SELECT id, CONCAT(first, ' ', last) AS name FROM Director WHERE CONCAT(first, ' ', last)='" . $director_name . "';";
                        ...
                        $director_info = mysqli_query($con,$director_query);

                        if ($director_info->num_rows == 0)
                        {
                            echo "Director not in the database.";
                            exit;
                        }
                        echo mysqli_fetch_row($movie_info)[1];
                        $director_id = mysqli_fetch_row($director_info)[0];
                        ...
                        $insert_query = "INSERT INTO MovieDirector (mid, did) VALUES (" . $movie_id. "," . $director_id . ");";
